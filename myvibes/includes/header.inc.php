  ...
  <div class="navbar-inner"> 
    <div class="container"><a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> 
      ...
      <div class="nav-collapse collapse"> 
        <ul class="nav">
          <li class="active"><a href="index.php"><i class="icon-home" style='margin-right:5px'></i>Home</a></li>
		<li><a href="friends.php"><i class="icon-user"></i><i class="icon-user" style='margin-right:5px'></i>Friends</a></li>
		<li><a href="plugin-index.php"></i><i class="icon-download" style='margin-right:5px'></i>Download Winamp Plugin</a></li>
