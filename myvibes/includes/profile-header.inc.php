    ...
    <div class="container"><a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> 
      ...
      <div class="nav-collapse collapse"> 
        <ul class="nav">
		  ...
		  <li class="dropdown,active"><a href="profile.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false"><i class="icon-user" style='margin-right:5px'></i>Profile<b class="caret" style='margin-left:3px'></b></a>
		...
		<li><a href="friends.php"><i class="icon-user"></i><i class="icon-user" style='margin-right:5px'></i>Friends</a></li>
		  ...
		  <li style='margin-left:400px'><a href="logout.php"><i class="icon-off" style='margin-right:5px'></i>Logout</a></li></div>
        </ul>
      </div>
      <!--/.nav-collapse -->
    </div>
