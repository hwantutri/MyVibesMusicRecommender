...
<?php include "includes/header-plugin.inc.php";?>
<body>
<div class="container">
	<div class="span12">
		<div class="span11">
		<div class="span10 background1" style='margin: 10px 0px 0px 35px;border-radius: 5px;'>
						<fieldset>
				<center><div class="pic"><img src="img/2213.png" width= "40%"/></div>
				<div class="tagline"><img src="img/tagline.png" width= "40%"/></div>
				</center>
				<div class="description">
				<p style='color:black;margin: 20px 40px 20px 40px'>You are required to download the Winamp Player(version 5.3 or higher) and the Winamp Plug-in.</br></br>
